  ...
  try {
    ...
    if (data.action === 'seedExercises') {
      ...
      var exData = [
        ...
        ['EX_030','Barbell Curl','Biceps','','Barbell','Hypertrophy','Bilateral bicep mass builder','Elbows fixed at sides, curl to shoulder height, full extension at bottom, no swinging','https://www.youtube.com/results?search_query=barbell+curl+proper+form+tutorial','EX_033','EX_031'],
        ['EX_031','Hammer Curl','Biceps','','Dumbbells','Hypertrophy','Neutral grip curl for brachialis and forearm strength','Neutral grip, curl with thumb pointing up throughout, control descent','https://www.youtube.com/results?search_query=hammer+curl+form+tutorial','EX_030','EX_033'],
        ['EX_032','Incline Dumbbell Curl','Biceps','','Dumbbells','Hypertrophy','Long head bicep isolation with full stretch','45 degree incline, arms hang fully, curl with maximum range for long-head stretch','https://www.youtube.com/results?search_query=incline+dumbbell+curl+form+tutorial','EX_030','EX_033'],
        ['EX_033','Cable Bicep Curl','Biceps','','Cable','Hypertrophy','Curl with constant cable tension throughout range','Low pulley, elbows fixed, curl and squeeze at top, resist the negative','https://www.youtube.com/results?search_query=cable+bicep+curl+form+tutorial','EX_030','EX_031'],
        ['EX_034','Concentration Curl','Biceps','','Dumbbells','Hypertrophy','Peak bicep contraction isolation','Seated, elbow braced on inner thigh, curl fully, squeeze hard at top','https://www.youtube.com/results?search_query=concentration+curl+form+tutorial','EX_030','EX_033'],
        ['EX_035','Preacher Curl','Biceps','','Barbell','Hypertrophy','Lower bicep isolation with shoulder support','Brace upper arms on pad, curl from full extension, squeeze at top','https://www.youtube.com/results?search_query=preacher+curl+form+tutorial','EX_030','EX_033'],
        ['EX_036','Tricep Pushdown','Triceps','','Cable','Hypertrophy','Cable tricep isolation for consistent tension','Elbows fixed at sides, extend to full lockout, control the return','https://www.youtube.com/results?search_query=tricep+pushdown+form+tutorial','EX_038','EX_037'],
        ['EX_037','Skull Crusher','Triceps','','Barbell','Hypertrophy','Long head tricep isolation movement','Lying on bench, lower bar to forehead hinging only at elbow, press to lockout','https://www.youtube.com/results?search_query=skull+crusher+form+tutorial','EX_036','EX_039'],
        ['EX_038','Cable Overhead Tricep Extension','Triceps','','Cable','Hypertrophy','Long head tricep with constant cable tension','Face away from cable, hinge forward, extend arms overhead keeping elbows close','https://www.youtube.com/results?search_query=cable+overhead+tricep+extension+form+tutorial','EX_037','EX_036'],
        ['EX_039','Close-Grip Bench Press','Triceps','Chest','Barbell','Strength','Tricep-focused compound press','Shoulder-width grip, elbows tucked 45 degrees, lower to chest, press to lockout','https://www.youtube.com/results?search_query=close+grip+bench+press+form+tutorial','EX_037','EX_036'],
        ['EX_040','Diamond Push-Up','Triceps','Chest','Bodyweight','Strength','Bodyweight tricep pressing movement','Hands in diamond shape under chest, elbows track back, lower to chest, press up','https://www.youtube.com/results?search_query=diamond+push+up+form+tutorial','EX_036','EX_039'],
        ['EX_041','Overhead Dumbbell Tricep Extension','Triceps','','Dumbbells','Hypertrophy','Long head tricep stretch with dumbbell','Hold dumbbell overhead with both hands, lower behind head, extend to lockout','https://www.youtube.com/results?search_query=overhead+dumbbell+tricep+extension+form+tutorial','EX_038','EX_037'],
        ['EX_042','Barbell Back Squat','Quads','Glutes','Barbell','Strength','King of leg movements for quad and lower body mass','Bar on traps, hip-width stance, squat to parallel or below, drive through heels','https://www.youtube.com/results?search_query=barbell+back+squat+proper+form+tutorial','EX_044','EX_043'],
        ['EX_043','Leg Press','Quads','Glutes','Machine','Hypertrophy','Quad press with reduced lower back demand','Feet hip-width on platform, lower to 90 degree knee angle, drive through full foot','https://www.youtube.com/results?search_query=leg+press+proper+form+tutorial','EX_042','EX_044'],
        ['EX_044','Hack Squat','Quads','Glutes','Machine','Strength','Quad-focused squat with supported back','Shoulders against pad, feet at bottom, squat deep, drive through full foot','https://www.youtube.com/results?search_query=hack+squat+machine+form+tutorial','EX_042','EX_043'],
        ['EX_045','Leg Extension','Quads','','Machine','Hypertrophy','Quad isolation for definition and mass','Adjust roller to lower shin, extend to full lockout, 2-second hold at top','https://www.youtube.com/results?search_query=leg+extension+machine+form+tutorial','EX_043','EX_047'],
        ['EX_046','Bulgarian Split Squat','Quads','Glutes','Dumbbells','Strength','Unilateral quad and glute movement','Rear foot elevated, front foot forward, descend until rear knee near floor','https://www.youtube.com/results?search_query=bulgarian+split+squat+form+tutorial','EX_042','EX_049'],
        ['EX_047','Goblet Squat','Quads','Glutes','Dumbbells','Strength','Squat with counterbalance for depth and form','Hold dumbbell at chest, squat deep, elbows push knees out, drive up tall','https://www.youtube.com/results?search_query=goblet+squat+form+tutorial','EX_042','EX_043'],
        ['EX_048','Smith Machine Squat','Quads','Glutes','Machine','Strength','Guided squat for safety and quad isolation','Feet slightly forward of bar, squat to parallel, drive through heels','https://www.youtube.com/results?search_query=smith+machine+squat+form+tutorial','EX_042','EX_043'],
        ['EX_049','Walking Lunges','Quads','Glutes','Dumbbells','Strength','Unilateral leg movement for quad, glute and stability','Step forward into lunge, knee over toe, push off front foot, step into next rep','https://www.youtube.com/results?search_query=walking+lunges+form+tutorial','EX_046','EX_057'],
        ['EX_050','Romanian Deadlift','Hamstrings','Glutes','Barbell','Strength','Hamstring and glute stretch-focused hinge','Soft knee bend, hinge from hips until bar at shin level, drive hips to lockout','https://www.youtube.com/results?search_query=romanian+deadlift+form+tutorial','EX_051','EX_052'],
        ['EX_051','Leg Curl','Hamstrings','','Machine','Hypertrophy','Hamstring isolation for size and balance','Lying face down, curl heels to glutes, brief hold, lower under control','https://www.youtube.com/results?search_query=lying+leg+curl+form+tutorial','EX_050','EX_054'],
        ['EX_052','Dumbbell Romanian Deadlift','Hamstrings','Glutes','Dumbbells','Strength','Hip hinge with dumbbells for hamstring and glute','Hold dumbbells in front of thighs, hinge keeping back flat, lower to shin level','https://www.youtube.com/results?search_query=dumbbell+romanian+deadlift+form+tutorial','EX_050','EX_051'],
        ['EX_053','Nordic Hamstring Curl','Hamstrings','','Bodyweight','Strength','Eccentric hamstring movement for injury prevention','Kneel with ankles anchored, lower body slowly under hamstring control, catch and push up','https://www.youtube.com/results?search_query=nordic+hamstring+curl+form+tutorial','EX_051','EX_050'],
        ['EX_054','Seated Leg Curl','Hamstrings','','Machine','Hypertrophy','Seated hamstring isolation with different angle','Pads across thighs, curl from full extension to full contraction, control return','https://www.youtube.com/results?search_query=seated+leg+curl+form+tutorial','EX_051','EX_050'],
        ...
        ['EX_062','Standing Calf Raise','Calves','','Machine','Hypertrophy','Primary calf builder for size and strength','Toes on edge, full range from deep stretch to full raise, 3-second descent','https://www.youtube.com/results?search_query=standing+calf+raise+form+tutorial','EX_063','EX_064'],
        ['EX_063','Seated Calf Raise','Calves','','Machine','Hypertrophy','Soleus-focused calf for lower leg development','Pads on knees, full range stretch to contraction, 3-second controlled descent','https://www.youtube.com/results?search_query=seated+calf+raise+form+tutorial','EX_062','EX_064'],
        ['EX_064','Single-Leg Calf Raise','Calves','','Bodyweight','Strength','Unilateral calf for balance and strength','Balance on step edge, full range raise, hold at top, control the descent','https://www.youtube.com/results?search_query=single+leg+calf+raise+form+tutorial','EX_062','EX_063'],
